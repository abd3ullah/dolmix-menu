...
interface FettucineSectionProps {
  items: MenuItem[];
...
export function FettuccineSection({ items, getItemQuantity, onAdd, onUpdateQty }: FettucineSectionProps) {
  if (items.length === 0) return null;

  return (
    <section id="fettuccine" className="py-6 px-4">
          ...
          {items.map(item => {
            ...
            return (
              <div
                ...
                className="bg-card border border-border/40 rounded-2xl overflow-hidden shadow-lg flex flex-col transition-shadow"
              >
